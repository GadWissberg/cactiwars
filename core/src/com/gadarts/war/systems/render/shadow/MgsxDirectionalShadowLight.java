 ...
 */
public class MgsxDirectionalShadowLight extends MgsxDirectionalLightEx implements ShadowMap, Disposable {
    ...
    public MgsxDirectionalShadowLight() {
        this(1024, 1024);
    }

    public MgsxDirectionalShadowLight(int shadowMapWidth, int shadowMapHeight) {
        this(shadowMapWidth, shadowMapHeight, 100, 100, 0, 100);
    }

    public MgsxDirectionalShadowLight(int shadowMapWidth, int shadowMapHeight, float shadowViewportWidth,
    ...
    public MgsxDirectionalShadowLight setShadowMapSize(int shadowMapWidth, int shadowMapHeight) {
    ...
    public MgsxDirectionalShadowLight setViewport(float shadowViewportWidth, float shadowViewportHeight, float shadowNear, float shadowFar) {
    ...
    public MgsxDirectionalShadowLight setCenter(Vector3 center) {
        this.center.set(center);
        return this;
    }

    public MgsxDirectionalShadowLight setCenter(float x, float y, float z) {
        this.center.set(x, y, z);
        return this;
    }

    public MgsxDirectionalShadowLight setBounds(BoundingBox box) {
    ...
    public boolean equals(MgsxDirectionalLightEx other) {
        return (other instanceof MgsxDirectionalShadowLight) ? equals((MgsxDirectionalShadowLight) other) : false;
    }

    public boolean equals(MgsxDirectionalShadowLight other) {
