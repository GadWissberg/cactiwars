...
public class PhysicsSystem extends GameEntitySystem implements EntityListener, GameContactListenerEventsSubscriber {
	...
	public void entityRemoved(Entity entity) {
		if (ComponentsMapper.physics.has(entity)) {
			...
			getCollisionWorld().removeCollisionObject(body);
		}
	}
	...
	public void subscribeForCollisionEvents(GameContactListenerEventsSubscriber subscriber) {
		contactListener.subscribe(subscriber);
	}
}
