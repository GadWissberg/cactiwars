...
public class ActorFactory {
	...
	private PhysicsComponent createPhysicsComponent(ActorDefinition def, Entity player, ModelInstance modelInstance, int mass) {
	...
	public void createBullet(Vector2 direction, Vector3 worldTranslation, WeaponDefinition weapon) {
		Entity bulletEntity = engine.createEntity();
		BulletComponent bulletComponent = engine.createComponent(BulletComponent.class);
		bulletEntity.add(bulletComponent);
		PhysicsComponent physicsComponent = engine.createComponent(PhysicsComponent.class);
		bulletEntity.add(physicsComponent);
		ModelInstanceComponent modelComponent = engine.createComponent(ModelInstanceComponent.class);
		modelComponent.init(modelInstancePool.obtain(weapon.getName(), weapon.getModel()));
