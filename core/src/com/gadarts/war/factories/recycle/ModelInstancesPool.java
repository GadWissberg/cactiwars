...
public class ModelInstancesPool {
    String DEBUG_MODEL_INSTANCE_POOL = "Model Instances Pool";
    String DEBUG_OBTAINED = "Obtained a new model instance:%s, left free: %d.";
    String DEBUG_FREED = "Freed a new model instance: %s, left free: %d.";
    String DEBUG_CREATING = "Creating a new model instance: %s";
